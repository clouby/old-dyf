...
<div class="info-operador-descripcion box">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="info-operador-precio box"></div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12 col-sm-8">
                <div class="box">
                    <ul class="list-unstyled info-operador-descripcion-nav box">
                        ...
                        <li><a href="#fotos"><span class="fa fa-photo"></span> Fotos</a></li>
                        <li><a href="#comentarios"><span class="fa fa-comments"></span> Comentarios</a></li>
                    </ul>
                </div>
